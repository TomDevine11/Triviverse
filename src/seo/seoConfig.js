...
export const ROUTES = [
  ...
  },
  {
    ...
    title: 'Football Wordle — Guess the Footballer | Triviverse',
  ...
  },
  {
    path: '/teammates',
    name: 'Teammates',
    title: 'Teammates — Guess the Footballer | Triviverse',
    description: 'Free daily game: guess the mystery footballer from their real teammates, revealed one by one. Name them in five guesses — a football "who are ya?" quiz.',
  ...
  },
  {
    path: '/career-path',
    name: 'Career Path',
    title: 'Career Path — Guess the Footballer | Triviverse',
    description: 'Free daily game — guess the footballer from their career path. Clubs are revealed one at a time; name the player who played for them all within five guesses.',

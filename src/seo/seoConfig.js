...
export const ROUTES = [
  {
    ...
    about: 'Triviverse brings together the best free daily football quiz games in one place. Test your knowledge with Football Wordle, fill a Football Tic-Tac-Toe grid, race against the clock in Football Tenable, or guess the mystery player from their teammates — all playable instantly in your browser on mobile or desktop.',
    howTo: [],
    sections: [
      {
  ...
  },
  {
    ...
    title: 'Football Wordle — Daily & Unlimited Word Game | Triviverse',
    description: "Play Football Wordle free: guess the mystery footballer's surname in six tries. A new player every day — green is the right spot, yellow the right letter.",
    keywords: ['football wordle', 'footdle', 'soccer wordle', 'footballer wordle', 'football word game', 'football wordle unlimited'],
    h1: 'Football Wordle',
  ...
  },
  {
    ...
    title: 'Guess the Footballer — Football Who Are Ya? | Triviverse',
    description: "Guess the Footballer — a free daily 'Who Are Ya?' game. Name the mystery player from his real teammates in five guesses. New player daily, no sign-up.",
    keywords: ['guess the footballer', 'who are ya', 'who are ya football', 'guess the football player', 'football guessing game', 'name the footballer', 'footy who are ya', 'guess the footballer game'],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: 'Football Tenaball — same game, however you spell it',
        body: [
    ...
    faq: [
      ...
      { q: 'Is Football Tenable free?', a: 'Yes — Football Tenable is completely free to play in your browser, with no sign-up or download. Daily gives one shared question a day; Unlimited lets you play as many as you like, free.' },
    ],
    schema: 'VideoGame',
    priority: '0.9',
    changefreq: 'daily',
  },
  {
    ...
    title: 'Football Connections — Daily & Unlimited Puzzle | Triviverse',
    description: 'Football Connections: a free daily puzzle of 16 footballers hiding four groups of four — clubs, nationalities and trophies. Find all four in four mistakes.',
  ...
  },
  {
    ...
    name: 'Football Higher or Lower',
    title: 'Football Higher or Lower — Daily & Unlimited | Triviverse',
    description: 'Football Higher or Lower — free streak game: pick which footballer scored more, across Premier League, La Liga, Champions League or international goals.',
    keywords: ['football higher or lower', 'higher lower football', 'football streak game', 'football goals quiz', 'guess who scored more'],
  ...
  },
  {
    path: '/501',
    name: 'Football 501',
    title: 'Football 501 — Football Darts Game | Triviverse',
    description: 'Football 501 is the free darts-style football stats game — count down from 501 by naming footballers by appearances or goals across Europe’s top leagues.',
...
export function metaTagsFor(route, lang = 'en') {
  ...
  const tags = [
    ...
    { name: 'theme-color', content: '#0b0a14' }, // pitch — must match the body canvas (design-tokens.md §1.1)
...
export function jsonLdFor(route, lang = 'en') {
  ...
  const organization = {
    ...
    name: BRAND,
    alternateName: 'Football Trivia Games', // pre-rebrand name — keeps existing search equity attached
    url: SITE_URL + '/',
  ...
  if (route.path === '/') {
    blocks.push({
      ...
      url: SITE_URL + '/',
      name: BRAND,
      alternateName: 'Football Trivia Games',
    ...
    blocks.push({
      ...
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Triviverse', item: SITE_URL + '/' },
